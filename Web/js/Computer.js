...
$(document).ready(function(){ 
	...
	//弹层拖动
	$('#form_pc_title').mousedown(function (event) { 
		var isMove = true; 
		var abs_x = event.pageX - $('#form_pc').offset().left; 
		var abs_y = event.pageY - $('#form_pc').offset().top; 
