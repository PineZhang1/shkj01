 ...
 */
@WebServlet(description = "Rest server for EAS service", urlPatterns = { "/servlet/ServEAS" })
public class ServEAS extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static String logconf=System.getProperty("user.dir").replace("\\bin", "")+"\\conf\\EAS\\log.properties";
	Logger logger = Logger.getLogger(ServEAS.class.getName());
	EAS api = new EAS();
