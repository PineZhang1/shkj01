 ...
 */
@WebServlet(description = "Rest server for apa service", urlPatterns = { "/servlet/ServSysConfig" })
public class ServSysConfig extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static String logconf=System.getProperty("user.dir").replace("\\bin", "")+"\\conf\\APA\\log.properties";
	Logger logger = Logger.getLogger(ServSysConfig.class.getName());
	SysConfig api = new SysConfig();
	
    public ServSysConfig() {
        super();
    }
